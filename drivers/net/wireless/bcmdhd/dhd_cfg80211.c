...
#if (LINUX_VERSION_CODE >= KERNEL_VERSION(3, 19, 0) || defined(WL_COMPAT_WIRELESS))
	/*cfg80211_disconnected(ndev, WLAN_REASON_DEAUTH_LEAVING, NULL, 0, true, GFP_KERNEL); modified by ratta */
	cfg80211_disconnected(ndev, WLAN_REASON_DEAUTH_LEAVING, NULL, 0, GFP_KERNEL);
#else
	cfg80211_disconnected(ndev, WLAN_REASON_DEAUTH_LEAVING, NULL, 0, GFP_KERNEL);
#endif
	return err;
