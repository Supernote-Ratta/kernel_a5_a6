...
const static char *bcm43456c5_ag_fw_name[] = {
...
dhd_conf_set_fw_name_by_chip(dhd_pub_t *dhd, char *fw_path)
{
	...
	switch (chip) {
		...
		case BCM43454_CHIP_ID:
			if (chiprev == BCM43456C5_CHIP_REV)
				strcpy(&fw_path[i+1], bcm43456c5_ag_fw_name[fw_type]);
			else if(chiprev == BCM43455C0_CHIP_REV)
